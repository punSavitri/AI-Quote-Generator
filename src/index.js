...
function generateQuote(event) {
  ...
  let context = "You are a expert AI assistant to personalised quote based on user personal interest.Your mission is to generate a short quote in basic HTML and separate line with a <br/>.Make sure answer is clear and precise . Please include author of the quotation inside a <strong> element at the bottom of the quote. Make sure to follow the user instruction.";
